    ...
    <section id="resources"> 
        ...
        <div id="modules"> 
            ...
            <div class="module"> 
                <h3>Project Name</h3> 
                <ul> 
                    <li><a href="registration.php">Blood Management System<br><br></a></li>
                    <p style="color:#ddd">This project will help to<br>fix the issue in the<br>medical blood management<br>which has been done manually</p> 
                </ul> 
            </div> 
            <div class="module"> 
                <h3>Team Members</h3> 
                <ul> 
                    ...
                    <li><a href="https://web.facebook.com/Shuvro.004">Adib Arman Shuvro</a></li>
                    <li><a href="https://web.facebook.com/arif.ishtiaq.13">Md.Arif Ishtiaq</a></li>
                    <li><a href="https://web.facebook.com/nhrupom">Md.Nadir Hosen Rupom</a></li>
                    <li><a href="https://web.facebook.com/mrahman.anik.1">Md.Mushfiqur Rahman Anik</a></li>
                    <li><a href="https://web.facebook.com/arthy.tabassum.9">Sumaiya Islam Mim</a></li>
                </ul> 
            </div> 
            <div class="module"> 
                <h3>&emsp;Contact</h3> 
                <ul> 
                    <li  ><a href="mailto: adibarmanshuvro89@gmail.com">&emsp;Support<br><br></a></li> 
                    <li ><a href="">&emsp;01767739907</a></li> 
                </ul> 
            </div> 
            <div class="module"> 
                <h3>Institute</h3>
                <ul>
                <li><a href="https://bauet.ac.bd/">Bangladesh Army University of Engineering & Technology (BAUET)<br><br></a></li>
                <p style="color:white">Qadirabad Cantonment<br>Dayarampur, Natore</p>   
                </ul>
            </div> 
        </div> 
    </section> 
...
<style>
/* Simple reset */
html, body, #body *, #footer *{ margin: 0; padding: 0; display: block; color: #3d3d3d; font-family: "Open Sans", sans-serif; font-size: inherit; font-weight: normal; text-decoration: none; line-height: 1.7; outline: 0; } 
